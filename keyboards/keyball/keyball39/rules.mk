...
# QMK changed the custom pointing-device init callback from void to bool.
ifneq ($(shell grep -c 'bool.*pointing_device_driver_init' quantum/pointing_device/pointing_device.h),0)
    OPT_DEFS += -DKEYBALL_MODERN_QMK
endif
...
# To support OLED
OLED_ENABLE = no                # Please enable this in individual keymaps.
