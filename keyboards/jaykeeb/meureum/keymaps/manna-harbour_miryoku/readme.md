...
This guide shows the Miryoku layout mapped to the Jaykeeb Meureum keyboard.
...
|-------|--------|---------|
| **Base** | Default | Primary typing layer (Colemak-DH) |
| **Extra** | Double-tap thumb | Secondary alpha layer (QWERTY) |
| **Tap** | Double-tap thumb | Plain alpha layer (no modifiers) |
| **Button** | Hold bottom pinkie | Mouse buttons for external pointing devices |
| **Nav** | Hold Left Space | Navigation and editing |
| **Mouse** | Hold Left Tab | Mouse emulation |
| **Media** | Hold Left Esc | Media and RGB controls |
| **Num** | Hold Right Bspc | Numbers and symbols |
| **Sym** | Hold Right Del | Shifted symbols |
| **Fun** | Hold Right Esc | Function keys |
...
**Legend:**
- `Key/Modifier` = Tap for key, Hold for modifier (Home Row Mods)
- `Key/Layer` = Tap for key, Hold for layer
- 🖱L = Left Mouse Button, R = Right Mouse Button
